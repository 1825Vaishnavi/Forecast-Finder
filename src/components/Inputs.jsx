  ...
  return (
    <div className="flex flex-row justify-center my-8">
        <div className="flex flex-row w-3/4 items-center space-x-4">
            ...
            type="text" 
            placeholder="search by city ..." className="text-gray-500 test-xl font-light p-2 w-full shadow-xl 
            capitalize  focus:outline-none placeholder:lowercase" />
            <BiSearch size={30}className="cursor-pointer transistion ease-out hover:scale-125"
            onClick={handleSearchClick}/>
            <BiCurrentLocation size={30}className="cursor-pointer transistion ease-out hover:scale-125"
